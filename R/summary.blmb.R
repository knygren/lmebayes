...
#'
#' @description
#' Summary method for row-block \code{\link[glmbayes]{lmb}} fits (class \code{"blmb"}).
#'
#' @param object An object of class \code{"blmb"} from \code{\link{lmbBlock}}.
...
#' @name summary.blmb
#' @aliases summary.blmb print.summary.blmb
NULL
