...
Theory justification and the underlying accept–reject / envelope construction are described in:
- Chapter A07 (the independent Normal–Gamma extension theory), and
- Nygren & Nygren (2006) for the base likelihood subgradient approach.
