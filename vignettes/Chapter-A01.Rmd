...
| **Lower-Level Interfaces (GLM / LM)** | **rlmb** | Chapter 17 — Linear mixed-effects models |
| **Lower-Level Interfaces (GLM / LM)** | **rglmb** | Chapter 18 — Generalized linear mixed-effects models |
...
| **pfamilies** |**dGamma, dNormal_Gamma, dIndependent_Normal_Gamma** | Chapter 15 — Estimating models with unknown dispersion parameters |
...
| **OpenCL host utilities** | \pkg{opencltools} (`detect_*`, PATH helpers, …) | Chapter 00 — Introduction; Chapter 01 — Getting Started |
