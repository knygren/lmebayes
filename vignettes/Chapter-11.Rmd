...
To illustrate this, we estimate the classical glm model and treat the resulting
...
a simple two-block Gibbs sampler may be used:
...
## Carinsca Gamma GLM (already fitted in the Carinsca chunk)
...
Because the Normal–Gamma prior is *conjugate* to the Gaussian likelihood, the
